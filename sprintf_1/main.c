...
int sprintf_03(void)
{
	...
	sprintf(buf, "abcdABCD0123 0x%x, %d, %d, 0x%x", 0xdeadbeef, 1983, 2014, 4096);
...
{
	int status = 0;
	int (*test[])(void) = { sprintf_00, sprintf_01, sprintf_02,
				sprintf_03, sprintf_04, sprintf_05,
				sprintf_06, sprintf_07 };
